...
let listInvitados = [
    {"id" : 1, "nombre" : "Alejo", "nombreCompleto" : "Alejandro ", "mensaje" : "" },
    {"id" : 2, "nombre" : "Pa'", "nombreCompleto" : "Alvaro Grisales", "mensaje" : "Sé que todo lo que has tenido me lo has dado y nunca dejaré de agradecerte por eso, no sería nada sin tu apoyo. Gracias a todo tu cariño, amor y esfuerzos hoy soy una gran mujer que desde ahora en adelante ha decidido compartir su vida del lado de un hombre que me brinda todo eso y mucho más de lo que tú me has dado. " },
    {"id" : 3, "nombre" : "Biata", "nombreCompleto" : "Beatriz Piedrahita", "mensaje" : "Nunca me alcanzará la vida para agradecerte todo lo que me brindaste a pesar de todas las dificultades. Me diste una nueva oportunidad y un nuevo camino, sabes que sin la ayuda de mi papá no sería lo que hoy soy, pero sin la tuya tampoco. Sé que algún día dije que no eras mi mamá, pero no comprendía realmente el significado de la palabra y de alguna u otra forma eso fuiste para mí a través de los años. Gracias por formar a esta gran mujer, que de ahora en adelante, por todo lo que le brindaste, tiene todas las herramientas para compartir su vida con alguien más. " },
    {"id" : 4, "nombre" : "Juanes", "nombreCompleto" : "Juan Esteban Acevedo", "mensaje" : "Gracias por aguantarme jeje al final eso es lo que hacen los hermanos,te guardo en mi corazón con mucho cariño y quiero que sepas que siempre serás mi familia. " },
    {"id" : 5, "nombre" : "Juli", "nombreCompleto" : "Julian David Acevedo", "mensaje" : "Gracias por aguantarme jeje al final eso es lo que hacen los hermanos,te guardo en mi corazón con mucho cariño y quiero que sepas que siempre serás mi familia." },
    ...
    {"id" : 16, "nombre" : "David", "nombreCompleto" : "Carlos David Ramirez", "mensaje" : "Mi primo, colega y amigo del alma. Cuando nos reunimos, volvemos a ser los niños de siempre. No existirá jamás una amistad mas sincera que la nuestra" },
    ...
    {"id" : 20, "nombre" : "Cata", "nombreCompleto" : "Catalina Ballesteros", "mensaje" : "Aunque pase el tiempo y no hablemos con frecuencia, nuestra amistad perdurará para siempre." },
    ...
    {"id" : 24, "nombre" : "Dilber", "nombreCompleto" : "Dilber Tangarife", "mensaje" : "Gracias por estar ahí en momentos donde nadie más estuvo, eres parte de mi historia y tú mejor que muchos sabes lo que me ha costado llegar hasta aquí, aunque en algunos momentos no creía que fuera posible hoy soy demasiado feliz, me encantaría que estuvieras conmigo, te quiero un montón." },
    ...
    {"id" : 45, "nombre" : "Jenny", "nombreCompleto" : "Jenny Rico", "mensaje" : "Tu familia será siempre un ejemplo a seguir, se que la nuestra será igual de hermosa. Gracias a tu ayuda y consejos, tenemos la certeza que este día será casi perfecto. Dios te bendiga siempre" },
    {"id" : 46, "nombre" : "Jhon", "nombreCompleto" : "Jhon Grisales", "mensaje" : "" },
    {"id" : 47, "nombre" : "Johan", "nombreCompleto" : "Johan Palacio", "mensaje" : "Todos tenemos un modelo a seguir en la vida, y desde que era niño, tú siempre has sido ese modelo para mí. Incluso ahora que somos adultos, tú y tu familia siguen siendo una fuente de inspiración para mí." },
    ...
    {"id" : 80, "nombre" : "Mi prima hermosa", "nombreCompleto" : "Rubi Ramirez", "mensaje" : "Eres mi prima adorada. Aunque ya no hablamos tanto, quiero que sepas que en mi corazón siempre llevaré los lindos momentos que vivimos juntos en nuestra infancia. ¡Te quiero mucho!" },
    {"id" : 81, "nombre" : "Negro", "nombreCompleto" : "Santiago (Negro)", "mensaje" : "" },
    {"id" : 82, "nombre" : "Santi", "nombreCompleto" : "Santiago Espinosa", "mensaje" : "Gracias por estar ahí durante tantos momentos, has sido un gran apoyo y te agradezco enormemente por ser mi amigo, espero poder brindarte las mismas cosas lindas que me has dado y también a la pequeña génesis. Te amo mucho y espero podamos compartir muchos momentos más juntos. " },
